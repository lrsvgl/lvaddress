...
namespace TYPO3\LvProddb\ViewHelpers;
...
class ImageViewHelper extends \TYPO3\CMS\Fluid\Core\ViewHelper\AbstractTagBasedViewHelper {
    ...
    public function initializeArguments() {
        ...
        #$this->registerTagAttribute('fallback', 'string', 'Specifies an image as fallback', FALSE);
    }
...
//        if (TYPO3_MODE === 'BE' && substr($fallback, 0, 3) === '../') {
//            $src = substr($fallback, 3);
//        }
        ...
        if (!is_array($imageInfo)) {
            ...
            throw new \TYPO3\CMS\Fluid\Core\ViewHelper\Exception('<img src="fileadmin/template/img/no_image.png"  width="130" alt="could not get image" />');
        }
